...
set_property DONT_TOUCH true [get_cells Uhrring]
set_property DONT_TOUCH true [get_cells Uhrring/Inv1]
set_property DONT_TOUCH true [get_cells Uhrring/Inv1/aus_i]
set_property DONT_TOUCH true [get_cells Uhrring/Inv2]
set_property DONT_TOUCH true [get_cells Uhrring/Inv2/aus_i]
set_property DONT_TOUCH true [get_cells Uhrring/Inv3]
set_property DONT_TOUCH true [get_cells Uhrring/Inv3/aus_i]

set_property DONT_TOUCH true [get_nets Uhrring/Inv1/aus]
set_property DONT_TOUCH true [get_nets Uhrring/Inv1/ein]
set_property DONT_TOUCH true [get_nets Uhrring/Inv2/aus]
set_property DONT_TOUCH true [get_nets Uhrring/Inv2/ein]
set_property DONT_TOUCH true [get_nets Uhrring/Inv3/aus]
set_property DONT_TOUCH true [get_nets Uhrring/Inv3/ein]
set_property DONT_TOUCH true [get_nets Uhrring/a1]
set_property DONT_TOUCH true [get_nets Uhrring/a2]
set_property DONT_TOUCH true [get_nets Uhrring/a3]
set_property DONT_TOUCH true [get_nets Uhrring/freqout]

set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets -of_objects [get_cells Uhrring/Inv1/aus_inferred__0_i_1]]
