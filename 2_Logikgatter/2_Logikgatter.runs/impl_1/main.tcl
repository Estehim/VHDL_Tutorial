...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/Weitere_Daten/USB_backup/Studienarbeit_FPGA/FPGA_Programm/1_tuturial_gatter/1_tuturial_gatter.cache/wt [current_project]
